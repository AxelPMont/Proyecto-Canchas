...
def crear_equipo():
    ...
    logo_file = request.files.get("logo")  # 👈 name="logo" del form
    ...
    if logo_file and logo_file.filename:
        ...
        upload_folder = current_app.config["UPLOAD_FOLDER"]  # static/img
        os.makedirs(upload_folder, exist_ok=True)
        logo_file.save(os.path.join(upload_folder, logo_filename))

    # aquí sí usamos tu método del modelo
    equipos_model.crear_equipo(
        nombre=nombre,
        categoria=categoria,
